  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        ...
        'h3': ['30px', { lineHeight: '1.3', fontWeight: '600', letterSpacing: '0' }],
        'h4': ['24px', { lineHeight: '1.3', fontWeight: '600', letterSpacing: '0' }],
        'h5': ['20px', { lineHeight: '1.4', fontWeight: '600', letterSpacing: '0' }],
        'h6': ['18px', { lineHeight: '1.4', fontWeight: '600', letterSpacing: '0' }],
        'body-lg': ['18px', { lineHeight: '1.5', fontWeight: '400' }],
        'body': ['16px', { lineHeight: '1.5', fontWeight: '400' }],
        'body-sm': ['14px', { lineHeight: '1.5', fontWeight: '400' }],
        'caption': ['12px', { lineHeight: '1.4', fontWeight: '400', letterSpacing: '0.02em' }],
        'button': ['16px', { lineHeight: '1', fontWeight: '500', letterSpacing: '0.01em' }],
      },
      colors: {
