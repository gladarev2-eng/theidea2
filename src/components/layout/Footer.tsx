      ...
      <div className="max-w-[1440px] mx-auto px-6 lg:px-12 py-16 lg:py-20">
        <div className="grid grid-cols-2 lg:grid-cols-6 gap-8 lg:gap-6">
          ...
          <div className="col-span-2">
            <Link to="/" className="text-lg tracking-[0.3em] font-light block mb-6">
              THE IDEA
            </Link>
            <p className="text-sm font-light text-white/50 mb-6 max-w-xs leading-relaxed">
              Фабрика дизайнерской мебели из Санкт-Петербурга. 
              12 лет создаём предметы, которые становятся основой интерьера.
            </p>
            <div className="space-y-2">
              <a href="tel:88002225043" className="block text-sm font-light text-white/70 hover:text-white transition-colors">
                8 (800) 222-50-43
              </a>
              <a href="mailto:info@theidea.ru" className="block text-sm font-light text-white/70 hover:text-white transition-colors">
                info@theidea.ru
              </a>
            </div>
          </div>
          ...
          {/* Catalog */}
          <div>
            <p className="text-[10px] uppercase tracking-[0.2em] text-white/40 mb-5">Каталог</p>
          ...
          {/* Collections */}
          <div>
            <p className="text-[10px] uppercase tracking-[0.2em] text-white/40 mb-5">Коллекции</p>
            <ul className="space-y-3">
          ...
          {/* Company */}
          <div>
            <p className="text-[10px] uppercase tracking-[0.2em] text-white/40 mb-5">Компания</p>
            <ul className="space-y-3">
          ...
          {/* Legal */}
          <div>
            <p className="text-[10px] uppercase tracking-[0.2em] text-white/40 mb-5">Информация</p>
            <ul className="space-y-3">
              {legalLinks.map((link) => (
                <li key={link.name}>
                  <Link 
        ...
        {/* Social Links */}
        <div className="mt-12 lg:mt-16 pt-8 border-t border-white/10 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
